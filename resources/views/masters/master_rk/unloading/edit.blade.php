...
@section('title', 'Edit RK Unloading')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit RK Unloading</h1>
        <a href="{{route('rk.unloading.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit RK Unloading</h6>
        </div>
        <form method="POST" action="{{route('rk.unloading.update', ['unloading' => $unloading->id])}}">
            @csrf
            @method('PUT')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input
                            ...
                            placeholder="From"
                            name="from"
                            value="{{ old('from') ?  old('from') : $unloading->from}}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input
                            ...
                            placeholder="No"
                            name="no"
                            value="{{ old('no') ? old('no') : $unloading->no }}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input
                            ...
                            placeholder="Jumlah"
                            name="jumlah"
                            value="{{ old('jumlah') ? old('jumlah') : $unloading->jumlah }}">
                    ...
                    {{-- Kompensator --}}
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        <span style="color:red;">*</span>Kompensator</label>
                        <input
                            type="text"
                            class="form-control form-control-user @error('kompensator') is-invalid @enderror"
                            id="examplekompensator"
                            placeholder="Kompensator"
                            name="kompensator"
                            value="{{ old('kompensator') ? old('kompensator') : $unloading->kompensator }}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input
                            ...
                            placeholder="Start"
                            name="start"
                            value="{{ old('start') ? old('start') : $unloading->start }}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input
                            ...
                            placeholder="Stop"
                            name="stop"
                            value="{{ old('stop') ? old('stop') : $unloading->stop }}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input
                            ...
                            placeholder="Menit"
                            name="menit"
                            value="{{ old('menit') ? old('menit') : $unloading->menit }}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input
                            ...
                            name="unloading"
                            value="{{ old('unloading') ? old('unloading') : $unloading->unloading }}">
            ...
            <div class="card-footer">
                ...
                <a class="btn btn-primary float-right mr-3 mb-3" href="{{ route('rk.unloading.index') }}">Cancel</a>
            </div>
        </form>
    </div>
