...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit RK loading</h1>
        <a href="{{route('rk.loading.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit RK loading</h6>
        </div>
        <form method="POST" action="{{route('rk.loading.update', ['loading' => $loading->id])}}">
            @csrf
            @method('PUT')
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    {{-- Out Kiln --}}
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        <span style="color:red;">*</span>Out Kiln</label>
                        <input
                            type="text"
                            class="form-control form-control-user @error('outKiln') is-invalid @enderror"
                            id="exampleoutKiln"
                            placeholder="Out Kiln"
                            name="outKiln"
                            value="{{ old('outKiln') ? old('outKiln') : $loading->outKiln }}">
            ...
            <div class="card-footer">
                ...
                <a class="btn btn-primary float-right mr-3 mb-3" href="{{ route('rk.loading.index') }}">Cancel</a>
            </div>
        </form>
    </div>
