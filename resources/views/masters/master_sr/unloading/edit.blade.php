...
@section('title', 'Edit SR Unloading')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit SR Unloading</h1>
        <a href="{{route('sr.unloading.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit SR Unloading</h6>
        </div>
        <form method="POST" action="{{route('sr.unloading.update', ['unloading' => $unloading->id])}}">
            @csrf
            @method('PUT')
            ...
            <div class="card-footer">
                ...
                <a class="btn btn-primary float-right mr-3 mb-3" href="{{ route('sr.unloading.index') }}">Cancel</a>
            </div>
        </form>
    </div>
